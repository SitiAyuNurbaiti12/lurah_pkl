              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    $sql = mysqli_query($koneksi,"SELECT * FROM pemohon INNER JOIN pj_usaha ON pemohon.id_pm=pj_usaha.id_pm WHERE username_pm='$username_pm'");
              ...
              <form role="form" action="" method="POST" enctype="multipart/form-data">
                <div class="card-body">
                  ...
                  <div class="row">
                    ...
                    <select name="jenis_ush" id="" class="form-control">
                      <option value="Toko">Toko</option>
                      <option value="Warung Makanan & Minuman">Warung Makanan & Minuman</option>
                      <option value="Toko Sembako">Toko Sembako</option>
                      <option value="Toko Sayuran">Toko Sayuran</option>
              ...
              <form role="form" action="" method="post" enctype="multipart/from-data">
                <div class="card-body">
                  ...
                  <div class="row">
                    ...
                    <label for="exampleInputEmail1">Jenis Usaha</label>
                    <select name="jenis_ush" id="" class="form-control">
                      <option value="<?=$ed['jenis_ush']?>"><?=$ed['jenis_ush']?></option>
                      <option value="Toko">Toko</option>
                      <option value="Warung Makanan & Minuman">Warung Makanan & Minuman</option>
                      <option value="Toko Sembako">Toko Sembako</option>
                      <option value="Toko Sayuran">Toko Sayuran</option>
