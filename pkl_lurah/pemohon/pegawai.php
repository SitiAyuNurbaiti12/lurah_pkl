  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Daftar Pegawai Kelurahan</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="index.php">Home</a></li>
              <li class="breadcrumb-item active">Daftar Pegawai Kelurahan</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Daftar Pegawai Kelurahan</h3>
      ...
      <div class="container-fluid">
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="index.php">Home</a></li>
              <li class="breadcrumb-item active">Input Daftar Pegawai Kelurahan</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
...
<!-- general form elements -->
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Input Daftar Pegawai Kelurahan</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
...
$tambah = mysqli_query($koneksi,"INSERT INTO pegawai (nip,nama,jabatan,jk,no_hp,alamat) VALUES('$nip','$nama','$jabatan','$jk','$no_hp','$alamat')");
if($tambah){
      ...
      <div class="container-fluid">
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="index.php">Home</a></li>
              <li class="breadcrumb-item active">Edit Daftar Pegawai Kelurahan</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
...
<!-- general form elements -->
            <div class="card card-warning">
              <div class="card-header">
                <h3 class="card-title">Edit Daftar Pegawai Kelurahan</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
                ...
                <div class="card-body">
                  ...
                  <div class="row">
                    ...
                    <div class="col-6">
                      <div class="form-group">
                    <label for="exampleInputPassword1">Nama Lengkap</label>
                    <input type="text" class="form-control" value="<?=$data['nama']?>" name="nama" id="exampleInputPassword1" placeholder="Nama Lengkap">
                  </div>
                    </div>
                  </div>
                  ...
                  <div class="row">
                    ...
                    <input type="text" class="form-control" value="<?=$data['alamat']?>" name="alamat" id="exampleInputPassword1" placeholder="Alamat">
                  </div>
                    </div>
                  </div>
...
$no_hp = $_REQUEST['no_hp'];
$alamat = $_REQUEST['alamat'];
$ubahsppd = mysqli_query($koneksi,"UPDATE pegawai SET nip = '$nip', nama = '$nama', jabatan = '$jabatan', jk = '$jk', no_hp = '$no_hp', alamat = '$alamat' WHERE id_pg = '$id_pg'");
