      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="vr_kematian.php" class="nav-link">
                  <i class="fas fa-file-alt nav-icon"></i>  
                  <p>Keterangan Kematian</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="vr_usaha.php" class="nav-link">
                  <i class="fas fa-file-alt nav-icon"></i>  
                  <p>Keterangan Usaha</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="vr_domisili.php" class="nav-link">
                  <i class="fas fa-file-alt nav-icon"></i>
                  <p>Keterangan Domisili</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="vr_tmampu.php" class="nav-link">
                  <i class="fas fa-file-alt nav-icon"></i>
                  <p>Keterangan Tidak Mampu</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="vr_pindah.php" class="nav-link">
                  <i class="fas fa-file-alt nav-icon"></i>  
          ...
          <li class="nav-item has-treeview">
            <a href="#" class="nav-link">
              ...
              <p>
                Register & Cetak Surat
                <i class="fas fa-angle-left right"></i>
              </p>
            </a>
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="rg_kematian.php" class="nav-link">
                  <i class="fas fa-file-alt nav-icon"></i>  
                  <p>Keterangan Kematian</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="rg_usaha.php" class="nav-link">
                  <i class="fas fa-file-alt nav-icon"></i>  
                  <p>Keterangan Usaha</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="rg_domisili.php" class="nav-link">
                  <i class="fas fa-file-alt nav-icon"></i>
                  <p>Keterangan Domisili</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="rg_tmampu.php" class="nav-link">
                  <i class="fas fa-file-alt nav-icon"></i>
                  <p>Keterangan Tidak Mampu</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="rg_pindah.php" class="nav-link">
                  <i class="fas fa-file-alt nav-icon"></i>  
                  <p>Keterangan Pindah</p>
                </a>
              </li>
