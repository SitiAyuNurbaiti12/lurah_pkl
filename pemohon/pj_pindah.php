              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    $sql = mysqli_query($koneksi,"SELECT * FROM pemohon INNER JOIN pj_pindah ON pemohon.id_pm=pj_pindah.id_pm WHERE username_pm='$username_pm'");
                ...
                <div class="card-body">
                  ...
                  <div class="row">
                    <div class="col-12">
                      ...
                      <select name="pendidikan_pdh" id="" class="form-control">
              ...
              <form role="form" action="" method="post" enctype="multipart/from-data">
                <div class="card-body">
                  <div class="row">
                    ...
                    <label for="exampleInputEmail1">Status Perkawinan</label>
                      <select name="status_kawin" id="" class="form-control">
                        <option value="<?=$ed['status_kawin']?>"><?=$ed['status_kawin']?></option>
                        <option value="Kawin">Kawin</option>
                        <option value="Belum Kawin">Belum Kawin</option>
                        <option value="Cerai Mati">Cerai Mati</option>
                        <option value="Cerai Hidup">Cerai Hidup</option>
                  ...
                  <div class="row">
                    <div class="col-12">
                      ...
                      <label for="exampleInputEmail1">Pendidikan Terakhir</label>
                      <select name="pendidikan_pdh" id="" class="form-control">
                        <option value="<?=$ed['pendidikan_pdh']?>"><?=$ed['pendidikan_pdh']?></option>
                        <option value="SD Sederajat">SD Sederajat</option>
                        <option value="SMP Sederajat">SMP Sederajat</option>
                        <option value="SMA Sederajat">SMA Sederajat</option>
                        <option value="D3">D3</option>
